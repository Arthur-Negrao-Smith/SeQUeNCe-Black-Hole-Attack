...
class Test_Data_Manager:
    ...
    def test_update_and_get_data(self, data_manager: Data_Manager, network_data: Network_Data) -> None:

        data_manager.update_data(network_data)
        assert data_manager.get_data().get_item(nd.CONSUMED_EPRS) == TEST_CONSUMED_EPRS


    def test_update_and_get_csv_dict(self, data_manager: Data_Manager, csv_dict_1: dict[str, list]) -> None:

        data_manager.update_csv_dict(csv_dict_1)
        assert data_manager.get_csv_dict() == csv_dict_1


    def test_update_and_get_json(self, data_manager: Data_Manager, json_1: dict) -> None:

        data_manager.update_json(json_1)
        assert data_manager.get_json() == json_1


    def test_load_and_write_csv(self, data_manager: Data_Manager, csv_dict_1: dict[str, list]) -> None:
    ...
    def test_load_and_write_json(self, data_manager: Data_Manager, json_1: dict[str, list]) -> None:
