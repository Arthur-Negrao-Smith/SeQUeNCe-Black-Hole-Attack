...
class Test_TopologyGen:
    ...
    def test_grid_topology_number_of_nodes_and_topology_name(self) -> None:
    ...
    def test_ring_topology_number_of_nodes_and_topology_name(self) -> None:
    ...
    def test_star_topology_number_of_nodes_and_topology_name(self) -> None:
    ...
    def test_line_topology_number_of_nodes_and_topology_name(self) -> None:
    ...
    def test_erdos_renyi_topology_number_of_nodes_and_topology_name(self) -> None:
    ...
    def test_barabasi_albert_topology_number_of_nodes_and_topology_name(self) -> None:
    ...
    def test_destroy_TopologyGen(self) -> None:
