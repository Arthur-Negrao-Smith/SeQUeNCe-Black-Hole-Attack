...
class Test_TopologyGen:
    ...
    def test_grid_topology_number_of_nodes_and_topology_name(
    ...
    def test_ring_topology_number_of_nodes_and_topology_name(
        self, network: Network
    ) -> None:
    ...
    def test_star_topology_number_of_nodes_and_topology_name(
        self, network: Network
    ) -> None:
    ...
    def test_line_topology_number_of_nodes_and_topology_name(
        self, network: Network
    ) -> None:
    ...
    def test_erdos_renyi_topology_number_of_nodes_and_topology_name(
        self, network: Network
    ) -> None:

        network.topology_generator.erdos_renyi_topology(
            number_of_nodes=self.number_of_nodes,
            prob_edge_creation=self.prob_edge_creation,
        )

        assert network.number_of_nodes == self.number_of_nodes
        assert network.topology == Topologies.ERDOS_RENYI

    def test_barabasi_albert_topology_number_of_nodes_and_topology_name(
        self, network: Network
    ) -> None:

        network.topology_generator.barabasi_albert_topology(
            number_of_nodes=self.number_of_nodes, edges_to_attach=self.edges_to_attach
        )
    ...
    def test_reproducibility_of_erdos_renyi(self) -> None:
        ...
        network_1.topology_generator.erdos_renyi_topology(
            number_of_nodes=self.number_of_nodes,
            prob_edge_creation=self.prob_edge_creation,
        )

        network_2: Network = Network(start_seed=self.seed_test)
        network_2.topology_generator.erdos_renyi_topology(
            number_of_nodes=self.number_of_nodes,
            prob_edge_creation=self.prob_edge_creation,
        )
    ...
    def test_reproducibility_of_barabasi_albert(self) -> None:
        ...
        network_1: Network = Network(start_seed=self.seed_test)
        network_1.topology_generator.barabasi_albert_topology(
            number_of_nodes=self.number_of_nodes, edges_to_attach=self.edges_to_attach
        )

        network_2: Network = Network(start_seed=self.seed_test)
        network_2.topology_generator.barabasi_albert_topology(
            number_of_nodes=self.number_of_nodes, edges_to_attach=self.edges_to_attach
        )
    ...
    def test_select_topology(self) -> None:
        ...
        for topology in Topologies:
            if topology == Topologies.NOT_DEFINED:
                continue
