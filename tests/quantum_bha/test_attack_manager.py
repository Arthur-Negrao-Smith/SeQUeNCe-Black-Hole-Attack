...
from quantum_bha.utils.enums import Attack_Types
import pytest as pt
...
class Test_Attack_Manager:
    ...
    def test_number_of_black_holes(self, network: Network) -> None:
        ...
        network.attack_manager.create_black_holes(
            number_of_black_holes=self.number_of_black_holes,
    ...
    def test_number_of_black_holes_in_get_black_holes(self, network: Network) -> None:
        ...
        assert (
            len(network.attack_manager.get_black_holes()) == self.number_of_black_holes
        )
    ...
    def test_number_of_targets_per_black_hole(self, network: Network) -> None:
        ...
        network.attack_manager.create_black_holes(
            number_of_black_holes=self.number_of_black_holes,
            swap_prob=self.swap_prob,
            targets_per_black_hole=self.targets_per_black_hole,
        )
    ...
    def test_reproducibility_for_black_hole_without_targets_creation(self) -> None:
        ...
        network_1.attack_manager.create_black_holes(
            number_of_black_holes=self.number_of_black_holes,
            swap_prob=self.swap_prob,
            targets_per_black_hole=0,
        )
        ...
        network_2.attack_manager.create_black_holes(
            number_of_black_holes=self.number_of_black_holes,
            swap_prob=self.swap_prob,
            targets_per_black_hole=0,
        )
        ...
        assert (network_1_bha._black_hole_targets is None) and (
            network_2_bha._black_hole_targets is None
        )
